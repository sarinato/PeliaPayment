													...
													<div style=" max-width:470px; background:#fff;border-radius:20px">
														...
														<div class="card joursSpicifier">
																...
																<form action="afectation.php" method="POST">
																		<div class="search-form medecin ">
																			<img  src="img/phone3.svg" width="6%" alt="">
																			<input type="text"  class="typeText" name="NumeroMedecin" value="<?php echo $key['numero_telephone']; ?>">
																		</div>

																		<div class="search-form medecin ">
																			<img  src="img/email3.svg" width="6%" alt="">
																			<input type="text" class="typeText" name="emailMedecin" value="<?php echo $key['email']; ?>">

																		</div>

																		<div class="search-form medecin ">
																			<img  src="img/adresse3.svg" width="6%" alt="">
																			<input type="text" class="typeText" name="adresseMedecin" value="<?php echo $key['adresse']; ?>">

																		</div>
																		<input type="text" style="display:none" name="IDMedecin" value="<?php echo $key['id_medecin']; ?>">

																		<div class="d-flex justify-content-center mt-5">
																	<button class="primary-btn contact100-form-btn" type="submit" name="modifierCordonnee">Enregistrer</button>
																	</div>
																		</form>
																		</div>
